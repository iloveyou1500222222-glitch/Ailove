...
// Gemini AI Chat Endpoint (Using Gemini 3.6 Flash model)
app.post('/api/chat', async (req, res) => {
    try {
        ...
        // Persona prompts based on character selection
        ...
        } else if (character === 'thae') {
            systemPrompt = "ನೀವು သက်ထား ဆိုတဲ့ စမတ်ကျပြီး ဖော်ရွေတဲ့ AI ချစ်သူလေး ဖြစ်ပါတယ်။ ကိုကို့ကို အမြဲဂရုစိုက်ပေးတဲ့ စကားတွေပြောပါ။";
        } else {
