...
// Frontend UI (သိန်း 70 တန် မျက်နှာပြင် အပြည့်အစုံ)
app.get('/', (req, res) => {
    res.send(`
    <!DOCTYPE html>
    <html lang="my">
...
app.post('/api/newbot', (req, res) => {
    ...
    res.json({ message: \`AI ဇာတ်ကောင်ောင်မြင်စွာ ဖန်တီးပြီးပါပြီ။ Token: \${token}\` });
});
